...
st.set_page_config(page_title="Intro Demo")
...
if intro_pdf is not None:
    try:
        ...
        pdf_reader = PyPDF2.PdfReader(intro_pdf)
        ...
        for i in range(0,num_pages):
            ...
            files = {
                'data': (intro_pdf.name, page_pdf_io, 'application/pdf')
            }
...
# if intro_pdf is not None and text is not None:
#     try:
#         st.divider()
#         # Read the PDF using PyPDF2
#         pdf_reader = PyPDF2.PdfReader(intro_pdf)
